...
//   private AssetFieldsConfiguration assetFieldsConfiguration;
    ...
    private Set<Role> getDefaultRoles() {
        ...
        return new HashSet<>(Arrays.asList(
                ...
                createRole("Technician", true, RoleCode.TECHNICIAN, Arrays.asList(PermissionEntity.WORK_ORDERS, PermissionEntity.ASSETS, PermissionEntity.LOCATIONS, PermissionEntity.FILES), Collections.emptyList(), Collections.emptyList(), Arrays.asList(PermissionEntity.WORK_ORDERS, PermissionEntity.LOCATIONS, PermissionEntity.ASSETS), Arrays.asList(PermissionEntity.WORK_ORDERS, PermissionEntity.LOCATIONS, PermissionEntity.ASSETS, PermissionEntity.CATEGORIES, PermissionEntity.PREVENTIVE_MAINTENANCES)),
                createRole("Limited Technician", true, RoleCode.LIMITED_TECHNICIAN, Arrays.asList(PermissionEntity.FILES), Collections.emptyList(), Collections.emptyList(), Collections.emptyList(), Arrays.asList(PermissionEntity.WORK_ORDERS, PermissionEntity.CATEGORIES, PermissionEntity.PARTS_AND_MULTIPARTS, PermissionEntity.LOCATIONS, PermissionEntity.ASSETS, PermissionEntity.PREVENTIVE_MAINTENANCES)),
