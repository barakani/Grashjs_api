...
public class WorkOrderRequestConfiguration {
    ...
    private Set<FieldConfiguration> fieldConfigurations = new HashSet<>(createFieldConfigurations(Arrays.asList("asset", "location", "assignedTo", "dueDate", "category", "team"), this, null));
