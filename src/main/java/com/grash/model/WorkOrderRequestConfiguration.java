...
public class WorkOrderRequestConfiguration {
    ...
    private Collection<FieldConfiguration> fieldConfigurations = createFieldConfigurations(Arrays.asList("asset", "location", "worker", "dueDate", "category", "team"), this, null);
